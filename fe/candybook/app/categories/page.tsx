      ...
      <div className="flex flex-col gap-2 rounded p-6 w-full">
        <div className="flex flex-row gap-10 p-4 w-full">
          <div className="basis-1/6 w-full">
            <h1 className="text-sm mb-2 ml-2 text-gray-500">Book name</h1>
            <Input
              name="moviename"
          ...
          <div className="basis-1/6 w-full">
            <h1 className="text-sm mb-2 ml-2 text-gray-500">Published year</h1>
            <Select
              items={yearArray}
              defaultSelectedKeys={[""]}
          ...
          <div className="basis-1/6 w-full">
            <h1 className="text-sm mb-2 ml-2 text-gray-500">Book type</h1>
            <Select
          ...
          <div className="basis-4/6 w-full">
            <h1 className="text-sm mb-2 text-gray-500">Categories</h1>
            <CheckboxGroup
              className="gap-2"
              color="secondary"
              onChange={(e: string[]) => {
